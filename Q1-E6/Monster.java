...
public class Monster {
    ...
    //added a randomizer for what the pokemon will do except if the previous move is a charge move
    public void chooseMove(Monster m){
        if (charge==true){
            this.attack(m);
        } else{
            int choice = (int) Math.floor(Math.random()*4.99);
            switch (choice) {
                case 0:
                this.attack(m);
                break;
